...
export const updateSettingsSchema = z.object({
  ...
  showDiagAppHealth: z.boolean().optional(),
  showDiagVehicleHealth: z.boolean().optional(),
  showDiagAnalytics: z.boolean().optional(),
  showDiagAnomalies: z.boolean().optional(),
  showDiagBatteryHealth: z.boolean().optional(),
  showDiagThermal: z.boolean().optional(),
  showDiagActivity: z.boolean().optional(),
  showDiagComparison: z.boolean().optional(),
