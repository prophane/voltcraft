      ...
      <Card>
        ...
        <div className="space-y-4">
          ...
          <div className="border-t border-border-subtle pt-6">
            <p className="text-sm font-medium text-text-primary mb-4">Visibilité des sections - Diagnostics</p>
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded accent-accent-500"
                  defaultChecked={s?.['showDiagAppHealth'] as boolean ?? true}
                  onChange={(e) => updateMutation.mutate({ showDiagAppHealth: e.target.checked })}
                />
                <span className="text-sm text-text-secondary">Afficher "Santé Application"</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded accent-accent-500"
                  defaultChecked={s?.['showDiagVehicleHealth'] as boolean ?? true}
                  onChange={(e) => updateMutation.mutate({ showDiagVehicleHealth: e.target.checked })}
                />
                <span className="text-sm text-text-secondary">Afficher "Santé Véhicule"</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded accent-accent-500"
                  defaultChecked={s?.['showDiagAnalytics'] as boolean ?? true}
                  onChange={(e) => updateMutation.mutate({ showDiagAnalytics: e.target.checked })}
                />
                <span className="text-sm text-text-secondary">Afficher "Analyses"</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded accent-accent-500"
                  defaultChecked={s?.['showDiagAnomalies'] as boolean ?? true}
                  onChange={(e) => updateMutation.mutate({ showDiagAnomalies: e.target.checked })}
                />
                <span className="text-sm text-text-secondary">Afficher "Anomalies de consommation"</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded accent-accent-500"
                  defaultChecked={s?.['showDiagBatteryHealth'] as boolean ?? true}
                  onChange={(e) => updateMutation.mutate({ showDiagBatteryHealth: e.target.checked })}
                />
                <span className="text-sm text-text-secondary">Afficher "Santé Batterie"</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded accent-accent-500"
                  defaultChecked={s?.['showDiagThermal'] as boolean ?? true}
                  onChange={(e) => updateMutation.mutate({ showDiagThermal: e.target.checked })}
                />
                <span className="text-sm text-text-secondary">Afficher "Suivi Thermique"</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded accent-accent-500"
                  defaultChecked={s?.['showDiagActivity'] as boolean ?? true}
                  onChange={(e) => updateMutation.mutate({ showDiagActivity: e.target.checked })}
                />
                <span className="text-sm text-text-secondary">Afficher "Activité Quotidienne"</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded accent-accent-500"
                  defaultChecked={s?.['showDiagComparison'] as boolean ?? true}
                  onChange={(e) => updateMutation.mutate({ showDiagComparison: e.target.checked })}
                />
                <span className="text-sm text-text-secondary">Afficher "Comparaison des Signaux"</span>
              </label>
            </div>
          </div>
